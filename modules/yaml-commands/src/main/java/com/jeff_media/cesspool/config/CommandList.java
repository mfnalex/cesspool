...
public class CommandList implements PlayerExecutable {
    ...
    /**
     * Creates a new CommandList containing a single command
     * @param command Command to add
     * @param type CommandSenderType
     * @return CommandList
     */
    public static CommandList of(@NotNull String command, @NotNull CommandSenderType type) {
